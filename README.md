...
<img src="docs/img/128x128.svadd g" style="margin:32px 0 0 0" width="128">
# Desktop TV Remote
...
<img src="docs/screenshots/android.png" style="margin-top: 64px" width="360">
*Android application main screen.*

<img src="docs/screenshots/cm.png" style="margin-top: 24px" width="960">
*It is easy to connect phone to app, just scan QR-code.*

<img src="docs/screenshots/sc.png" style="margin-top: 24px" width="960">
*The shortcut is global, so it will work even if the app does not have the keyboard focus.*

<img src="docs/screenshots/rc.png" style="margin-top: 24px" width="960">
*There is over 1000 vendors in database.*

<img src="docs/screenshots/rc2.png"  style="margin-top: 24px" width="960">
